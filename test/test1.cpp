 ...
 *
 */
TEST(VectorZeroCopy, BackInserter1)
{
    const int N = 50;

    typedef std::vector<int> Container;
    typedef std::back_insert_iterator<Container> It;
    typedef z0rg::zero_copy<int, It> ZC;

    bool is_zero_copy = z0rg::traits::is_zero_copy<ZC>::value;
    ASSERT_EQ(false, is_zero_copy);
 ...
 *
 */
TEST(VectorZeroCopy, BackInserter2)
{
    const int N = 50;
 ...
 *
 */
TEST(VectorZeroCopyScoped, BackInserter)
{
    const int N = 50;
